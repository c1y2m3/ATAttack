...
#
# $Id: smbexec.py 903 2013-11-07 21:10:06Z bethus@gmail.com $
#
...
class CMDEXEC:
    ...
    def __init__(self, protocols = None, 
                 username = '', password = '', domain = '', hashes = None, mode = None, share = None, serviceName=None):
        if not protocols:
        ...
        if not serviceName:
            ...
            self.__serviceName = serviceName.encode('utf-16le')
